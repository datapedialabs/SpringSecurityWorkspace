...
public class JdbcCalendarUserDao implements CalendarUserDao {
	...
	@Override
	public int createAuthorities(int userId) {
		return jdbcOperations.update("insert into  calendar_user_authorities(calendar_user,authority) values (?,?)",  userId, "ROLE_USER");
	}
}