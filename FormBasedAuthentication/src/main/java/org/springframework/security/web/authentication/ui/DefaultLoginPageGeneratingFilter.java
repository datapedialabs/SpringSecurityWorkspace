...
public class DefaultLoginPageGeneratingFilter extends GenericFilterBean {
	...
	static{
		System.out.println("###static block inside DefaultLoginPageGeneratingFilter class###");
	}
	...
	private String generateLoginPageHtml(HttpServletRequest request, boolean loginError,
		...
		System.out.println("###generateLoginPageHtml method in DefaultLoginPageGeneratingFilter class ###");
		...
		if (loginError) {
			System.out.println("###loginError in generateLoginPageHtml method in DefaultLoginPageGeneratingFilter class ###");
		...
		if (logoutSuccess) {
			System.out.println("###logoutSuccess in generateLoginPageHtml method in DefaultLoginPageGeneratingFilter class ###");
			sb.append("<p><font color='green'>You have been logged out</font></p>");
		}

		if (formLoginEnabled) {
			System.out.println("###formLoginEnabled in generateLoginPageHtml method in DefaultLoginPageGeneratingFilter class ###");
