...
public class DaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		System.out.println("###DaoAuthenticationProvider###"+ userDetails.getUsername()+" : " + userDetails.getPassword());
		System.out.println("###DaoAuthenticationProvider###"+ authentication.toString());
		System.out.println("###DaoAuthenticationProvider###presentedPassword:"+ authentication.getCredentials().toString());
		Object salt = null;
