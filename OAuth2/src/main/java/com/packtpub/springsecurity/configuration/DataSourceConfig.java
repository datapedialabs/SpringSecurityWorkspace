...
@ComponentScan(basePackages = { "com.packtpub.springsecurity.dataaccess", "com.packtpub.springsecurity.service", "com.packtpub.springsecurity.authentication" })
...
public class DataSourceConfig {
	...
	public DataSource dataSource() {
		...
		database = builder.setType(EmbeddedDatabaseType.H2)
				...
				.addScript("classpath:database/h2/JdbcUsersConnectionRepository.sql")
				.build();
		return database;
	}
